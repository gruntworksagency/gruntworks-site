...
const Features: React.FC = () => {
  return (
    <section className="bg-[#1D150E] py-2">
      <div className="container mx-auto px-4 max-w-[850px] text-center">
        <Pill
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4  mx-auto">
          {featureCardsData.map((card, index) => (
            <div key={index} className="relative w-full md:basis-1/3 max-w-[358px] aspect-[358/448] rounded-lg overflow-hidden mx-auto flex-shrink-0">
              <Image
